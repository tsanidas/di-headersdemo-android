package com.diveinsoft.blog.headers.infrastructure
...
class ApiClient(
    ...
    companion object {
        @JvmStatic
        protected val baseUrlKey = "com.diveinsoft.blog.headers.baseUrl"

        @JvmStatic
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(baseUrlKey, "https://headers-demo.ue.r.appspot.com")
        }
    }
}
